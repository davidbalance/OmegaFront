...
interface ExamSubtypeFormUpdateProps {
    type: number;
...
const ExamSubtypeFormUpdate: React.FC<ExamSubtypeFormUpdateProps> = ({ type, examSubtype, onClose, onFormSubmit }) => {
