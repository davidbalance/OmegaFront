...
interface ExamSubtypFormChangeTypeProps extends Omit<React.HTMLProps<HTMLFormElement>, 'ref' | 'type'> {
    type: number;
    options: ExamType[]
}

const ExamSubtypFormChangeType = React.forwardRef<HTMLFormElement, ExamSubtypFormChangeTypeProps>(({
    options,
    type,
    ...props
}, ref) => {
...
ExamSubtypFormChangeType.displayName = 'ExamSubtypFormChangeType'

export default ExamSubtypFormChangeType;