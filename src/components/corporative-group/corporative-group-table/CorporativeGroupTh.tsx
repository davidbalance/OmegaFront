...
import classes from './CorporativeGroupTh.module.css'

type CorporativeGroupThProps = {
...
const CorporativeGroupTh: React.FC<CorporativeGroupThProps> = ({ children, sort }) => {
...
export default CorporativeGroupTh