...
interface UserFormAssignEmployeeOfProps {
    user: number;
    onClose: () => void;
}
const UserFormAssignEmployeeOf: React.FC<UserFormAssignEmployeeOfProps> = ({ user, onClose }) => {
    ...
    } = useFetch<GETUserAttributeRequestDto>(`/api/users/attribute/employee/${user}`, 'GET');
    ...
    } = useFetch<any>(`/api/users/attribute/employee/${user}`, 'PATCH', { loadOnMount: false });
...
export default UserFormAssignEmployeeOf