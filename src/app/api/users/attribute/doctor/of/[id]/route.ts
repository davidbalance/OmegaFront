...
export async function GET(
    ...
    try {
        ...
        const attribute: GETUserAttributeRequestDto = await getAttribute(endpoints.USER.USER.ATTRIBUTES.DOCTOR_OF.FIND(params.id), { cacheExpirationSeconds: 30 });
...
export async function PATCH(
    ...
    try {
        ...
        await patchAttribute(endpoints.USER.USER.ATTRIBUTES.DOCTOR_OF.FIND_ONE_AND_UPDATE(params.id), { body: data });
