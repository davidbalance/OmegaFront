...
export async function GET(
    ...
    try {
        ...
        const attribute: GETUserAttributeRequestDto = await getAttribute(endpoints.USER.USER.ATTRIBUTES.LOOK_FOR.FIND(params.id), {
...
export async function PATCH(
    ...
    try {
        ...
        await patchAttribute(endpoints.USER.USER.ATTRIBUTES.LOOK_FOR.FIND_ONE_AND_UPDATE(params.id), {
            body: data,
            headers: CONTENT_TYPE_APPLICATION_JSON
        });
