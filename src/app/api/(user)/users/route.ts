...
export async function POST(req: NextRequest) {
    try {
        ...
        await patchRole(endpoints.WEB.CLIENT.RESOURCE.FIND_USER_AND_UPDATE_RESOURCES(user.id!), {
            body: { resources },
            headers: CONTENT_TYPE_APPLICATION_JSON
        });
        ...
        await patchLogo(endpoints.WEB.CLIENT.LOGO.FIND_USER_AND_UPDATE_LOGO(user.id!), {
            body: { logo },
            headers: CONTENT_TYPE_APPLICATION_JSON
        });
