...
import Form from '@/components/disease/group/form/DiseaseGroupForm';
import { ModularBox } from '@/components/modular/box/ModularBox';
import { DiseaseGroup } from '@/lib/dtos/disease/group/base.response.dto'
import { parseForm } from '@/lib/utils/form-parse';
import { updateDiseaseGroup } from '@/server/disease-group.actions';
...
interface FormProps extends DiseaseGroup { }
const DiseaseGroupForm: React.FC<FormProps> = ({
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        setLoading(true);
        try {
            await updateDiseaseGroup(id, values);
            router.back();
        } catch (error: any) {
