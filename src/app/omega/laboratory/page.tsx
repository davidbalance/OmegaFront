...
import { retriveExamTypes } from '@/server';
import { PaginationResponse } from '@/lib/types/pagination.type';
import { ExamSubtype } from '@/server/exam-subtype/server-types';
import { retriveExamSubtypes } from '@/server';
import { Exam } from '@/server/exam/server-types';
import { retriveExams } from '@/server';
import ExamTypeList from './_components/exam-type-list';
import ExamSubtypeList from './_components/exam-subtype-list';
